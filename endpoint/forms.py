...
class SLConfigForm(Form):
    ...
    num_workers = IntegerField('num_workers', validators=[DataRequired()], default=1)
    ...
    sl_cpus = SelectField('sl_cpus', choices=cpus, validators=[DataRequired()], default='1')

    memory = [('1024','1024'), ('2048','2048'), ('4096','4096'), ('8192','8192'),
        ('16384','16384'), ('32768','32768'), ('65536','65536')]
    sl_memory = SelectField('sl_memory', choices=memory, validators=[DataRequired()], default='1024')

    disk_capacity = [('25','25'), ('100','100')]
    sl_disk_capacity = SelectField('sl_disk_capacity', choices=disk_capacity, validators=[DataRequired()], default='25')

    network_speed = [('10','10'), ('100','100'), ('1000','1000')]
    sl_network_speed = SelectField('sl_network_speed', choices=network_speed, validators=[DataRequired()], default='100')
